        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="" method="post">
                    ...
                    <input type="text" name="nganhang" class="form-control" placeholder="( ex: MBBANK: 012345678 )" value="<?=$row['ngan_hang'];?>">
                    </div>
                    
                    <div class="form-group">
                    <label for="exampleInputEmail1">Ví MoMo </label>
                    <input type="text" name="momo" class="form-control" placeholder="( ex: 012345678)" value="<?=$row['vi_momo'];?>">
                    </div>
